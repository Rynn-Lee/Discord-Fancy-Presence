    ...
    <>
      <fieldset>
        ...
        <Input
          ...
          onChange={(e) =>
            setAppInfo({ ...appInfo, largeImageKey: e.target.value })
          }
        />
        <Input
          ...
          onChange={(e) =>
            setAppInfo({ ...appInfo, largeImageText: e.target.value })
          }
        />
      </fieldset>
      <fieldset>
        ...
        <Input
          ...
          onChange={(e) =>
            setAppInfo({ ...appInfo, smallImageKey: e.target.value })
          }
        />
        <Input
          ...
          onChange={(e) =>
            setAppInfo({ ...appInfo, smallImageText: e.target.value })
          }
        />
      </fieldset>
    </>
