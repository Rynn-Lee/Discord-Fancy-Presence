...
const Display = ({width, height}: any) => {
  return(
    <svg width={width ? `${width}px` : "20px"} height={height ? `${height}px` : "20px"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"/>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>
...
const Settings = ({width, height}: any) => {
  return(
    <svg width={width ? `${width}px` : "20px"} height={height ? `${height}px` : "20px"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" strokeWidth="0"/>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>
