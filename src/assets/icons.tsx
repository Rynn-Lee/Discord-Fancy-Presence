...
const Settings = (props: IconProps) => {
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {' '}
        <circle cx="12" cy="12" r="3" stroke="#dadde0" strokeWidth="1.5" />{' '}
        <path
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          ...
          strokeLinecap="round"
        />{' '}
        <circle cx="12" cy="16" r="1" fill="#dadde0" />{' '}
        <path
          d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7"
          stroke="#dadde0"
          strokeWidth="1.5"
...
const Server = (props: IconProps) => {
  return(
    <svg width="20px" height="20px" {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="SVGRepo_iconCarrier"> <path d="M13 21H6C4.11438 21 3.17157 21 2.58579 20.4142C2 19.8284 2 18.8856 2 17C2 15.1144 2 14.1716 2.58579 13.5858C3.17157 13 4.11438 13 6 13H18C19.8856 13 20.8284 13 21.4142 13.5858C22 14.1716 22 15.1144 22 17C22 18.8856 22 19.8284 21.4142 20.4142C20.8284 21 19.8856 21 18 21H17" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M11 2H18C19.8856 2 20.8284 2 21.4142 2.58579C22 3.17157 22 4.11438 22 6C22 7.88562 22 8.82843 21.4142 9.41421C20.8284 10 19.8856 10 18 10H6C4.11438 10 3.17157 10 2.58579 9.41421C2 8.82843 2 7.88562 2 6C2 4.11438 2 3.17157 2.58579 2.58579C3.17157 2 4.11438 2 6 2H7" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M13.5 6L18 6" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M6 7L6 5" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M9 7L9 5" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M13.5 17H18" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M6 18L6 16" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> <path d="M9 18L9 16" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> </g>
    </svg>
  )
}
...
const User = (props: IconProps) => {
  return(
    <svg width="20px" height="20px" {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="SVGRepo_bgCarrier" stroke-width="0"/>
      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
      <g id="SVGRepo_iconCarrier"> <circle cx="12" cy="6" r="4" stroke="#dadde0" stroke-width="1.5"/> <path d="M19.9975 18C20 17.8358 20 17.669 20 17.5C20 15.0147 16.4183 13 12 13C7.58172 13 4 15.0147 4 17.5C4 19.9853 4 22 12 22C14.231 22 15.8398 21.8433 17 21.5634" stroke="#dadde0" stroke-width="1.5" stroke-linecap="round"/> </g>
    </svg>
  )
}
...
const Icon = {
  App,  Display,  Info,  Settings,  FAQ,  Pen,  Eye, Remove, Check, ExclamationMark, Server, User, Refresh
}
